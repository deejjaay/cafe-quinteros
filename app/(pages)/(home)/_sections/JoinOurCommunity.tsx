...
const JoinOurCommunityPage = () => {
    return (
        <section className="bg-cover bg-center bg-opacity-70 bg-[url('/images/discover/mobile/map.png')]">
            <div className='container xl:max-w-xl bg-primary opacity-90'>
                <div 
                    className="md:py-custom-60 py-custom-40"
                >
                    <div className="gap-[80px] md:flex-wrap grid xl:grid-cols-2">
                        ...
                        <Image 
                            ...
                            height={410}
                            alt={'Map'} 
                            className="w-auto md:h-[410px] lg:h-[251px] object-fill rounded-[8px]"
                        />
                    </div>
                </div>
            </div>
